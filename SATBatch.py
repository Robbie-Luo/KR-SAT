...
def main():
    ...
    f = open("results/top91_random_selection.txt", 'w')
    f.writelines(rs)

    f = open("results/top91_jeroslow_wang.txt", 'w')
    f.writelines(jw)

    f = open("results/top91_jeroslow_wang_2_sided.txt", 'w')
    f.writelines(jw2)

    f = open("results/top91_most_often.txt", 'w')
    f.writelines(mo)

    f = open("results/top91_freeman.txt", 'w')
    f.writelines(fm)
